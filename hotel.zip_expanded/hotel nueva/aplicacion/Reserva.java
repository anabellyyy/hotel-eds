 ...
 *
 * anabel ramos
 modifico los nombres con refactor, y posteriormente rename
 */
...
public class Reserva {
    ...
    /**
     * corrigo nombre con refactor rename
     */
    
    /* corrigo nombres con refactor rename*/
    ...
    private static int obtenerCodigoReserva() {
        setContadorReservas(getContadorReservas() + 1);
        return getContadorReservas();
    }
	...
	/**
	 * @return the contadorReservas
	 */
	private static int getContadorReservas() {
		return contadorReservas;
	}


	/**
	 * @param contadorReservas the contadorReservas to set
	 */
	private static void setContadorReservas(int contadorReservas) {
