...
public class Hotel {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				/* extraigo de las lineas 46 a 70 para otro metodo altaCliente */
				try {
					cliente1 = extracted(sc);
	 ...
	 * @throws Exception
	 */
	public static Cliente extracted(Scanner altaCliente) throws Exception {
		Cliente cliente1;
		String nombre;
		do {
			System.out.println("\nIntroduzca los datos del cliente:");
			System.out.print("Nombre: ");
			nombre = altaCliente.nextLine();
